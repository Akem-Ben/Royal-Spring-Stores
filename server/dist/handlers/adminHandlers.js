...
exports.adminGetSingleOrder = exports.adminGetAllUserOrders = exports.adminGetAllOrders = exports.getAllHomeProducts = exports.getSingleUser = exports.getAllUsers = exports.deleteProduct = exports.updateProduct = exports.getsingleProduct = exports.getAllProducts = exports.CreateProduct = exports.adminLogin = exports.CreateAdmin = exports.CreateSuperadmin = void 0;
...
const adminGetAllOrders = async (req, res) => {
    try {
        ...
        const admin = await AdminModel_1.default.find({ _id: id });
        if (!admin) {
...
const adminGetAllUserOrders = async (req, res) => {
    try {
        ...
        const admin = await AdminModel_1.default.findById({ _id: adminId });
        console.log(admin);
        if (admin) {
            ...
            const order = await OrderModel_1.default.find({ userId: userId });
            if (!order) {
                res.status(404).json({
...
exports.adminGetAllUserOrders = adminGetAllUserOrders;
const adminGetSingleOrder = async (req, res) => {
    try {
        ...
        const order = await OrderModel_1.default.findById({ _id: orderId });
        if (!order) {
            return res.status(404).json({
                Error: `Order not found`
            });
...
exports.adminGetSingleOrder = adminGetSingleOrder;
