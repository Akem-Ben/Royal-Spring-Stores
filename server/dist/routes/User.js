...
router.get('/get-all-orders', auth_1.userAuth, userHandlers_1.userGetAllOrders);
router.get('/get-single-order/:id', auth_1.userAuth, userHandlers_1.userGetsSingleOrder);
router.delete('/delete-single-order/:id', auth_1.userAuth, userHandlers_1.deleteSingleOrder);
router.delete('/delete-all-orders', auth_1.userAuth, userHandlers_1.deleteAllOrders);
