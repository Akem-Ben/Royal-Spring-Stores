...
exports.userCreatesOrder = exports.updateUser = exports.userProfile = exports.getsingleProduct = exports.getAllProducts = exports.Login = exports.Register = void 0;
...
const userCreatesOrder = async (req, res) => {
    try {
        const { id } = req.user;
        const { name, qty, image, price, shippingAddress, paymentMethod, itemsPrice, taxPrice, shippingPrice, city, country, totalPrice } = req.body;
        ...
        const user = (await UserModel_1.default.findOne({ id: id }));
        if (!user) {
            return res.status(400).json({
                message: "User not found",
            });
        }
        const order = OrderModel_1.default.create({
            userId: id,
            postalCode: "",
            name,
            qty,
